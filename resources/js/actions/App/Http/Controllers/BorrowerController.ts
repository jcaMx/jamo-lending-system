 ...
 * @see app/Http/Controllers/BorrowerController.php:18
 * @route '/borrowers'
 */
 ...
 * @see app/Http/Controllers/BorrowerController.php:58
 * @route '/borrowers'
 */
...
const BorrowerController = { index, add, store, search, show, update }
