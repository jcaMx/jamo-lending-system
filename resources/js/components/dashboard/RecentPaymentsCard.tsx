...
export function RecentPaymentsCard({ payments }: RecentPaymentsCardProps) {
  return (
    <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-200/70 h-fit">
      ...
      <div className="p-6 md:p-7 space-y-4">
        {payments.slice(0, 5).map((payment: Payment) => {
          const config = paymentStatusConfig[payment.status as keyof typeof paymentStatusConfig];
