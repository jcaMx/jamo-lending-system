 ...
 * @route '/applynow'
 */
export const applynow = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: applynow.url(options),
    method: 'get',
})
 ...
 * @route '/applynow'
 */
applynow.url = (options?: RouteQueryOptions) => {
    return applynow.definition.url + queryParams(options)
}
 ...
 * @route '/applynow'
 */
applynow.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: applynow.url(options),
    method: 'get',
})
/**
 ...
 * @route '/applynow'
 */
applynow.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: applynow.url(options),
    method: 'head',
})
 ...
 * @route '/applynow'
 */
    const applynowForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: applynow.url(options),
        method: 'get',
    })
 ...
 * @route '/applynow'
 */
        applynowForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: applynow.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/applynow'
 */
        applynowForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: applynow.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
